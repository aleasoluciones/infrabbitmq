...
parser.add_argument('-n', '--network', action='store', default=common.local_net_name(), help='')
...
rabbitmq_client = factory.json_event_publisher(args.destination_exchange, broker_uri=broker_uri)
